    ...
    <div className="min-h-screen bg-slate-900 text-white py-12 px-4">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-white/70 mt-2">Select how you want to join Gauras Mart.</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-10">
          Already have an account? <Link href="/sign-in" className="text-amber-400 font-bold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
