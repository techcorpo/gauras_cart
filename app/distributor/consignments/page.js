...
export default function DistributorConsignments() {
  ...
  return (
    <FodderShell role="distributor" title="Bilty / Consignments" description="View your items in manufacturer shipments.">
              ...
              <div className="space-y-3">
                {detail.orders.map(o=> (
                  <div key={o.id} className="border border-[#e4ece7] dark:border-[#24332b] rounded-lg p-3">
                    <div className="font-bold text-sm mb-2">PO #{o.order_number}</div>
                    <table className="w-full text-sm">
