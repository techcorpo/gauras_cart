...
// --- Feature API modules ---
export const Admin = {
  clearTransactions: () => apiFetch('/admin/retest/clear', { method: 'POST', auth: true }),
...
export const Consignments = {
  create: (payload) => apiFetch('/consignments', { method: 'POST', auth: true, body: payload }),
  list: () => apiFetch('/consignments', { auth: true }),
  get: (id) => apiFetch('/consignments/' + id, { auth: true }),
};
export const Orders = {
  ...
  setPayment: (id, payment_status, details) => apiFetch('/orders/' + id + '/payment', { method: 'PATCH', auth: true, body: { payment_status, ...details } }),
  updateItemQty: (id, itemId, quantity) => apiFetch('/orders/' + id + '/items/' + itemId, { method: 'PUT', auth: true, body: { quantity } }),
